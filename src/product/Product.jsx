...
const Product = () => {
  ...
  const products = [
    {
      id: "managed",
      name: "8CH4D-SBA-SwitchBoard",
      status: "Active",
      type: "smartbuildauto",
    },
    {
      id: "managed",
      name: "6CH1D-SBA-SwitchBoard",
      status: "Inactive",
      type: "smartbuildauto",
    },
    {
      id: "managed",
      name: "10CH2F2-SBA-SwitchBoard",
      status: "Active",
      type: "smartbuildauto",
    },
    {
      id: "managed",
      name: "6CH2F1-SBA-SwitchBoard",
      status: "Active",
      type: "smartbuildauto",
    },
  ...
  return (
    <div className="products">
      <div
        className={`product-top ${isDarkMode ? "bg-[#313135] text-white" : ""}`}
      >
        <div className="label-area">
          <i
            class="fa-brands fa-codepen fa-lg"
      ...
      <section>
        <div className="product-list">
          <div className="prd-list-fltr">
            <div className="ght">
              <i
                className={`fas fa-grip ${view === "grid" ? "selected" : ""}`}
                onClick={() => handleViewChange("grid")}
              ></i>{" "}
              {/* Grid view icon */}
              <i
                className={`fas fa-list ${view === "table" ? "selected" : ""}`}
