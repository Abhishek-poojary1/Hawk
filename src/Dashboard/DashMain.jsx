  ...
  return (
    <div>
      <div className='main-content'>
        ...
        <div className='msgFilter' style={{ display: 'flex', paddingLeft: 20, paddingRight: 50, justifyContent: 'space-between', alignItems: 'center', paddingTop: 10 }}>
          {/* Label on the left */}
          <label style={{ fontSize: '1.25rem', fontWeight: 500, lineHeight: 1.25 }}>Total Messages: 64150</label>

          {/* Dropdown select for filter on the right */}
          <select className='filtr' value={selectedFilter} onChange={handleFilterChange}>
            <option className='filtr' value="14">Last 14 Day's</option>
            <option className='filtr' value="7">Last 7 Day's</option>
            <option className='filtr' value="1">Last 24 Hours</option>
          </select>
        </div>
        ...
        <section className='xyz' style={{ paddingTop: 30 }}>
          ...
          <div className='msg-card' style={{ opacity: 1, transform: 'none' }}>
            <div className='px-4 py-3 flex gap-2 justify-between item-center' style={{ display: 'flex', alignItems: 'center', height: '20px' }}>
              ...
              <span className='content-heading dark:text-white right:0' style={{ paddingLeft: '50px' }}>32601</span>
          ...
          <div className='msg-card' style={{ opacity: 1, transform: 'none' }}>
            <div className='px-4 py-3 flex gap-2 justify-between item-center' style={{ display: 'flex', alignItems: 'center', height: '20px' }}>
              ...
              <span className='content-heading dark:text-white right:0' style={{ paddingLeft: '50px' }}> 3267</span>
            </div>
          ...
          <div className='msg-card' style={{ opacity: 1, transform: 'none' }}>
            <div className='px-4 py-3 flex gap-2 justify-between item-center' style={{ display: 'flex', alignItems: 'center', height: '20px' }}>
              ...
              <span className='content-heading dark:text-white right:0' style={{ paddingLeft: '50px' }}>25015</span>
            </div>
        ...
        <div className='msgFilter' style={{ display: 'flex', justifyContent: 'space-between', paddingLeft: 20, alignItems: 'center', paddingTop: 30 }}>
          {/* Label on the left */}
          <label style={{ fontSize: '1.25rem', fontWeight: 500, lineHeight: 1.25 }}>Recent Updates</label>
        </div>
